...
Here you can add users into your environment by selecting users from the fields. The role of the user can be edited from drop down and click `Add user` button. 
